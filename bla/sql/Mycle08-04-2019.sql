...
create table produto(id int not null auto_increment primary key, nomeProduto varchar(100) not null, cor varchar(20),valorAtacad decimal(5,2),valorVarejo decimal(5,2) not null, descProduto
...
create table conta(id int not null primary key auto_increment, usuario varchar(100) not null, senha varchar(32) not null)Engine = Innodb, charset  = utf8;

create table contato(id int not null primary key auto_increment, email varchar(255) not null, telefone varchar(16), celular varchar(16) not null,id_pessoa int not null)Engine = Innodb, charset  = utf8;

create table endereco(id int not null primary key auto_increment, estado varchar(50) not null, cidade varchar(50) not null,bairro varchar(50) not null 
...
create table pessoa(id int not null primary key auto_increment,nome varchar(200) not null, sexo boolean, id_login int not null,id_dados_pessoais int not null)Engine = Innodb, charset  = utf8;
